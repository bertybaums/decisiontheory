...
When asked about the probability that the cab involved in the accident was blue rather green, most of us are inclined to say \(80\%\). The correct answer, however, is about \(41\%\). The reason why the probability is lower than \(80\%\) is that blue cabs are rare. In other words, we failed to account for the first piece of information.\footnote{When we fail to incorporate information about base rates, it is known as the \emph{base rate fallacy}.} The reasoning we did to get to the correct answer (\(41\%\)) reflects a thinking about \emph{both} pieces of information.
