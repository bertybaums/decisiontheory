...
\begin{marginfigure}
\includegraphics{decisiontheory_files/figure-latex/unnamed-chunk-22-1} \includegraphics{decisiontheory_files/figure-latex/unnamed-chunk-22-2} \caption[Conditional probability in a fair die roll]{Conditional probability in a fair die roll}\label{fig:unnamed-chunk-22}
\end{marginfigure}
